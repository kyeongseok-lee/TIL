# TIL :turtle:
#### 오늘 내가 배운 것 Today I Learned :fire:
...
- [What_a_Algorithm](./Algorithm/What_a_Algorithm.md)
- [list~~Greedy](./Algorithm/list~~Greedy.md)
- [2ndList~selection](./Algorithm/2ndList~selection.md)
- [시계방향순차정렬](./Algorithm/시계방향순차정렬.py)
- [strings](./Algorithm/strings.md)
- [string_문자열찾기](./Algorithm/string_문자열찾기.py)
